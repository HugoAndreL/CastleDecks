...
namespace API.Migrations
{
    ...
    [Migration("20230626204446_Spell and Familiar")]
    partial class SpellandFamiliar
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.Familiar", b =>
                {
                    b.Property<int>("Id_Familiar")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id_Familiar"), 1L, 1);

                    b.Property<string>("Img_Familiar")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Name_Familiar")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Phrase_Familiar")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("SpellId")
                        .HasColumnType("int");

                    b.HasKey("Id_Familiar");
            ...
            modelBuilder.Entity("API.Models.Spell", b =>
                {
                    b.Property<int>("Id_Spell")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id_Spell"), 1L, 1);

                    b.Property<string>("Desc_Spell")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("HowDo_Spell")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Name_Spell")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("API.Models.TypeWeapon", b =>
                {
                    b.Property<int>("Id_TypeWeapon")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id_TypeWeapon"), 1L, 1);

                    b.Property<string>("Name_TypeWeapon")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id_TypeWeapon");

                    b.ToTable("TypesWeapons");
                });
            ...
            modelBuilder.Entity("API.Models.Weapons", b =>
                {
                    ...
                    b.Property<int>("TypeWeaponId")
                        .HasColumnType("int");

                    b.HasKey("Id_Weapon");

                    b.HasIndex("TypeWeaponId");
            ...
            modelBuilder.Entity("API.Models.Familiar", b =>
                {
                    b.HasOne("API.Models.Spell", "Spell_Familiar")
                        .WithOne("Familiar_Spell")
                        .HasForeignKey("API.Models.Familiar", "SpellId");

                    b.Navigation("Spell_Familiar");
                });
            ...
            modelBuilder.Entity("API.Models.Item_and_Monster", b =>
                {
                    ...
                    b.HasOne("API.Models.Monsters", "Monsters")
            ...
            modelBuilder.Entity("API.Models.Weapons", b =>
                {
                    b.HasOne("API.Models.TypeWeapon", "TypeWeapon_Weapon")
                        .WithMany("Weapons_TypeWeapon")
                        .HasForeignKey("TypeWeaponId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TypeWeapon_Weapon");
                });
            ...
            modelBuilder.Entity("API.Models.Spell", b =>
                {
                    b.Navigation("Familiar_Spell");
                });

            modelBuilder.Entity("API.Models.TypeWeapon", b =>
                {
                    b.Navigation("Weapons_TypeWeapon");
                });
